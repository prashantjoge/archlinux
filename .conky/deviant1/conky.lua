...
},
{
    ...
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=0.3,
    caption='cpu 2',
    caption_weight=2,              caption_size=8.0,
    caption_fg_colour=0xFFFFFF,    caption_fg_alpha=0.5,
},
{
...
{
    name='fs_used_perc',           arg='/mnt/backup/',                max_value=100,
    x=40,                          y=406,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='hwmon',           arg='1 temp 1',                max_value=100,
    x=40,                          y=791,
    graph_radius=18,
    graph_thickness=5,
    graph_start_angle=180,
