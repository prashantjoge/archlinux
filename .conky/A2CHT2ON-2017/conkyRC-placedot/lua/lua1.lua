...
This script draws percentage meters as rings. It is fully customizable; all options are described in the script.
...
+ v1.0 -- Original release (28.09.2009)
        ...
        arg=conky_parse("${if_up wls1}wls1${else}wls1${endif}"),
        fg_colour=0xf0651f,
        fg_colour=conky_parse("${if_up wls1}wls1${else}wls1${endif}"),
        conky_parse("${cpu}")
...
function iface_watch()
    ...
    iface=conky_parse("${if_existing /proc/net/route wls1}wls1${else}wls1${endif}")
