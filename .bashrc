...
## LiqPrompt if [ "$PS1" ]; then
##	complete -cf sudo man
##fi

echo "sudo from .bashrc@home"
...
## commenetd out for liquid prompt function parse_git_branch() {
...
# get current status of git repo: Commented out to test liquid prompt
